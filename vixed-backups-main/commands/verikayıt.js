        ...
        if (!savedChannel) {
          if(channel.type === "voice"){
            ...
            let newChannelSchema = new ChannelData({
              ...
              type: channel.type,
              topic: channel.topic ? channel.topic : "Bu kanal vixed Backup botu tarafından kurtarıldı!",
              permissionOverwrites: permissionss,
            });
            newChannelSchema.save();
          }
          ...
          if(channel.type === "voice"){
            ...
            savedChannel.type = channel.type;
            savedChannel.time = Date.now();
            savedChannel.topic = channel.topic ? channel.topic : "Bu kanal vixed Backup botu tarafından kurtarıldı!";
            savedChannel.permissionOverwrites = permissionss;
            savedChannel.save();
          }
        };
